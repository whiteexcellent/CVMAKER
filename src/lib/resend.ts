...
export const sendWelcomeEmail = async (to: string, name: string) => {
    return await sendEmail(
        ...
        `<div style="font-family: sans-serif; color: #333;">
            ...
            <p>Our Claude 3.5 Sonnet engine is ready to bypass any ATS system and secure you more interviews.</p>
            <br/>
            <a href="https://yourwebsite.com/wizard" style="background-color: #2563eb; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px;">Build Your CV Now</a>
         </div>`
    );
};
