...
import { Search01Icon, SquareArrowReload01Icon, Building04Icon } from "@hugeicons/core-free-icons";
        ...
        <Card className="bg-white dark:bg-black border-black/10 dark:border-white/10 text-black dark:text-white shadow-sm">
            <CardHeader>
                <CardTitle className="text-2xl font-black tracking-tight flex items-center gap-2">
                    <HugeiconsIcon icon={Building04Icon} className="w-5 h-5"  strokeWidth={1.5} /> {t('dashboard.findCompanies')}
                </CardTitle>
            ...
            <CardContent>
                ...
                <form onSubmit={handleCompanySearch} className="flex flex-col md:flex-row gap-4 mb-8">
                    ...
                    <Button type="submit" disabled={isCompanySearching} className="bg-black hover:bg-black/80 dark:bg-white dark:hover:bg-white/90 text-white dark:text-black font-bold h-11">
                        {isCompanySearching ? <HugeiconsIcon icon={SquareArrowReload01Icon} className="w-4 h-4 animate-spin"  strokeWidth={1.5} /> : <HugeiconsIcon icon={Search01Icon} className="w-4 h-4 mr-2"  strokeWidth={1.5} />}
